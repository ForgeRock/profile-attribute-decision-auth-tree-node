 ...
 */
public class ProfileAttributeDecisionNodePlugin extends AbstractNodeAmPlugin {
     ...
     */
    @Inject
    public ProfileAttributeDecisionNodePlugin(AnnotatedServiceRegistry serviceRegistry) {
    ...
    protected Iterable<? extends Class<? extends Node>> getNodes() {
        return asList(
                ProfileAttributeDecisionNode.class
        );
    }
}
